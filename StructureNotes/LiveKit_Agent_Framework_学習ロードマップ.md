...
**Phase 3（Agent Server インフラ層）を進行中。**
※ Multimodality Overview（🔄）は概要ページ。個別ページ（Text/Audio/Vision）で内容はカバー済みのため、必要に応じて読む。

次のドキュメント: **Server Startup Modes** → https://docs.livekit.io/agents/server/startup-modes/
